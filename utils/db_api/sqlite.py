...
"""
    ...
    def add_user_uz(self, id: int, name: str, language: str = 'uz'):
    ...
    def add_user_ru(self, id: int, name: str, language: str = 'ru'):
        # SQL_EXAMPLE = "INSERT INTO Users(id, Name, email) VALUES(1, 'John', 'John@gmail.com')"
    ...
    def add_user_en(self, id: int, name: str, language: str = 'en'):
        # SQL_EXAMPLE = "INSERT INTO Users(id, Name, email) VALUES(1, 'John', 'John@gmail.com')"
